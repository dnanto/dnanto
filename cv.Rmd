...
In the browser with JavaScript to export SVG diagrams (democapsid @ https://dnanto.github.io/democapsid/capsid.html). On the GPU with GLSL for realtime renders (protocapsid @ https://www.shadertoy.com/view/dlsGRH).
